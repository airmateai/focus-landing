    ...
    <div className="min-h-screen text-[#1c1a16] marble-bg">
      ...
      >
        <div className="max-w-4xl mx-auto px-6 py-4 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 text-center">
          <span className="inline-flex items-center gap-2 text-white font-black text-sm sm:text-base">
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 shrink-0">
              <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.472-.148-.671.15-.198.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.672-1.62-.921-2.22-.242-.583-.487-.504-.671-.513-.173-.008-.372-.01-.571-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z" />
              <path d="M12.004 2C6.486 2 2 6.486 2 12.004c0 1.86.505 3.679 1.464 5.267L2 22l4.867-1.44a9.96 9.96 0 0 0 5.137 1.437h.004c5.518 0 10.004-4.486 10.004-10.004C22 6.486 17.522 2 12.004 2zm0 18.264h-.003a8.24 8.24 0 0 1-4.2-1.15l-.3-.179-3.12.923.933-3.043-.196-.312a8.234 8.234 0 0 1-1.264-4.4c0-4.554 3.706-8.26 8.263-8.26 2.207 0 4.281.86 5.84 2.42a8.204 8.204 0 0 1 2.417 5.842c0 4.554-3.706 8.26-8.264 8.26z" />
            </svg>
            {t.whatsappBanner}
          </span>
        </div>
