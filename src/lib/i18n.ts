...
export const dict = {
  es: {
    ...
    insiders: {
      ...
      urgency: "1€ solo durante las próximas 24h. Después, se acabó.",
    ...
    pricing: {
      kicker: "1€ solo durante 24h",
      title: "Únete ahora, antes de que se acabe",
      price: "1€",
      nextPrice: "49,99€",
      period: "primer mes",
      warning: "Oferta válida solo durante las próximas 24h. Después, se acabó — no hay prórroga.",
  ...
  en: {
    ...
    insiders: {
      ...
      urgency: "€1 for the next 24h only. After that, it's over.",
    ...
    pricing: {
      kicker: "€1 for 24h only",
      title: "Join now, before it's gone",
      price: "€1",
      nextPrice: "€49.99",
      period: "first month",
      warning: "Offer valid only for the next 24h. After that, it's over — no extension.",
