...
export const dict = {
  es: {
    ...
    pricing: {
      ...
      nextPrice: "49,99€",
      period: "/mes",
      warning: "El precio subirá a 49,99€/mes próximamente. Quien entra ahora, mantiene 29,99€ para siempre — sin excepciones.",
      cta: "Asegurar mi plaza al precio actual",
  ...
  en: {
    ...
    pricing: {
      ...
      nextPrice: "€49.99",
      period: "/mo",
      warning: "Price is going up to €49.99/mo soon. Lock in €29.99 now and keep it forever — no exceptions.",
      cta: "Lock in my spot at this price",
