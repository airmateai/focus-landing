...
export const dict = {
  es: {
    ...
    insiders: {
      ...
      urgency: "1€ hasta el 1 de septiembre. Después, se acabó.",
    ...
    pricing: {
      kicker: "1€ hasta el 1 de septiembre",
      title: "Únete ahora, antes de que se acabe",
      price: "1€",
      nextPrice: "49,99€",
      period: "primer mes",
      warning: "Oferta válida solo hasta el 1 de septiembre. Después, se acabó — no hay prórroga.",
  ...
  en: {
    ...
    insiders: {
      ...
      urgency: "€1 until September 1st. After that, it's over.",
    ...
    pricing: {
      kicker: "€1 until September 1st",
      title: "Join now, before it's gone",
      price: "€1",
      nextPrice: "€49.99",
      period: "first month",
      warning: "Offer valid only until September 1st. After that, it's over — no extension.",
