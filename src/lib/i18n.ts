...
export const dict = {
  es: {
    ...
    pricing: {
      kicker: "10€ el primer mes",
      title: "Únete ahora, antes de que suba el precio",
      price: "10€",
      nextPrice: "29,99€",
      period: "primer mes",
      warning: "Después, 29,99€/mes. Cancela cuando quieras, sin permanencia.",
      cta: "Activar Focus por 10€",
  ...
  en: {
    ...
    pricing: {
      kicker: "€10 the first month",
      title: "Join now, before the price goes up",
      price: "€10",
      nextPrice: "€29.99",
      period: "first month",
      warning: "Then €29.99/month. Cancel anytime, no commitment.",
      cta: "Activate Focus for €10",
